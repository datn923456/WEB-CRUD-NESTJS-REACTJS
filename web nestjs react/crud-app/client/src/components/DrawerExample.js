import { Drawer,DrawerOverlay,DrawerCloseButton,DrawerHeader,DrawerBody,DrawerFooter,Button,DrawerContent,Stack} from "@chakra-ui/react"
      ...
      <>
        ...
        >
          ...
          <DrawerContent>
            ...
            <DrawerBody>
              <Stack spacing={"24px"}>
                <InputsGroup name="fullname" onChangeHandler={onChangeHandler} value={form?.fullname} errors={errors?.fullname}/>
                ...
                <InputsGroup name="country" onChangeHandler={onChangeHandler} value={form?.country} errors={errors?.country}/>
              </Stack>
            </DrawerBody>
